...
const TotalTask = ({totalLength}) => {
  return (
    <Card className='shadow' style={{ width: '22rem', height: '10rem' , border: 'none' }}>
      <Card.Body>
        <Card.Title className='text-muted'>Total Task</Card.Title>
        <Card.Subtitle className="mb-2 d-flex justify-content-between align-items-center">
            <h3>{totalLength ? totalLength : 0}</h3>
            <div className='card_bg text-white rounded-5 bg-primary d-flex justify-content-center align-items-center'>
